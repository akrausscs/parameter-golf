...
class Hyperparameters:
    ...
    late_ema_decay = float(os.environ.get("LATE_EMA_DECAY", "0.95"))
...
def main() -> None:
    ...
    while True:
        ...
        if args.late_qat_threshold > 0 and scale < args.late_qat_threshold and not CastedLinear._qat_enabled:
            ...
            ema_decay = args.late_ema_decay  # fast EMA: track QAT-annealed weights
            log0(f"late_qat:enabled late_ema:decay={ema_decay} step:{step} scale:{scale:.4f}")
        zero_grad_all()
